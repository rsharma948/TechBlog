                    ...
                    <div class="modal-body">
                        <div>
                            ...
                            <form id="add-post-form" action="AddPostServlet" method="post">
                                ...
                                <div class="form-group">
                                    <textarea name="pContent" class="form-control" style="height:180px;" placeholder="Enter content here"></textarea>
                                </div>
                                <div class="form-group">
                                    <textarea name="pCode" class="form-control" style="height:140px;" placeholder="Enter your Code(if any)"></textarea>
                                </div>
                                <div class="form-group">
